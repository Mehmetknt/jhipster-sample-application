            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('minSalary')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.job.minSalary">Min Salary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('maxSalary')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.job.maxSalary">Max Salary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
